...
const contactCards = [
  {
    icon: "bi-geo-alt",
    title: "Location",
    text: "750 Lexington Avenue, New York, NY 10022",
  },
  { icon: "bi-envelope", title: "Email", text: "sales@infomanage.net" },
  { icon: "bi-telephone", title: "Call", text: "212-931-0705" },
  {
    icon: "bi-clock",
    title: "Business Hours",
    text: "Mon–Fri: 8AM – 6PM · Enterprise: 24×7",
  },
];
      ...
      <div className="container">
        ...
        >
          ...
          <div>
            ...
            >
              Schedule a consultation to discuss your environment and learn how
              structured IT management can improve reliability, security, and
          ...
          <div className="contact-right">
            ...
            >
              ...
              {sent && (
                ...
                >
                  Opening your email app to send this request. If it doesn't
                  open, please email us directly.
                </div>
              )}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-field">
                  <textarea
                    className="form-input"
                    placeholder="Briefly describe your IT environment and what you are looking to improve..."
                    required
                    rows={5}
                    value={form.message}
                    onChange={(e) =>
