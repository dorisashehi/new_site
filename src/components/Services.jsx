...
const services = [
  ...
  },
  {
    ...
    desc: 'An extension of your staff, not just a vendor.',
    bullets: [
      'Comprehensive support for your internal IT operations',
      'Network, endpoint, and system management',
      'Technology planning aligned with your business goals',
    ],
    cta: 'Learn About ITSM',
    to: '/managed-it-services',
  },
  {
