...
const principles = [
  ...
  },
  {
    ...
    bullets: ['Continuous monitoring', 'Threat identification', 'Security event detection'],
  },
  {
    num: '03',
    ...
    bullets: ['Rapid incident response', 'Containment procedures', 'System restoration'],
  },
];
...
const services = [
  {
    ...
    bullets: ['Endpoint detection and response', 'Anti-malware protection', 'Threat monitoring'],
  },
  {
  ...
  },
  {
    ...
    bullets: ['System alerts', 'Infrastructure health checks', 'Security event detection'],
  },
  {
    ...
    bullets: ['Patch management', 'System configuration controls', 'Access management'],
  },
];

const incidentSteps = [
  { num: '01', icon: 'bi-search', title: 'Identification & Triage', desc: 'Issue is identified, categorized, and initial severity assessment performed.' },
  { num: '02', icon: 'bi-shield-x', title: 'Containment & Mitigation', desc: 'Affected systems are isolated to prevent further spread or damage.' },
  { num: '03', icon: 'bi-people-fill', title: 'Vendor Coordination', desc: 'Third-party vendors and specialists are engaged where necessary.' },
  { num: '04', icon: 'bi-arrow-clockwise', title: 'Restoration & Follow-up', desc: 'Systems are restored and a post-incident review is conducted.' },
];

const forOrgsItems = [
  { icon: 'bi-pc-display', text: 'Rely on technology to run daily operations' },
  { icon: 'bi-arrow-repeat', text: 'Need proactive protection rather than reactive response' },
  { icon: 'bi-puzzle-fill', text: 'Want security integrated into their IT management' },
  { icon: 'bi-cloud-check-fill', text: 'Require reliable backup and recovery capabilities' },
  { icon: 'bi-bar-chart-line-fill', text: 'Value ongoing security monitoring and maintenance' },
];
        ...
        <section className="cyber-hero">
          ...
          <div className="container mit-hero-content" data-aos="fade-up" data-aos-delay="100">
            ...
            <p className="mit-hero-sub">
              Protecting business systems through proactive monitoring, layered defenses, and structured security management.
            </p>
            <p className="mit-hero-body">
              Cybersecurity is no longer a separate function from IT operations. Modern threats require continuous
              monitoring, proactive defense, and disciplined operational practices.
            </p>
            <p className="mit-hero-body">
              InfoManage integrates cybersecurity directly into technology operations, helping organizations protect
        ...
        <section className="cyber-principles">
          <div className="container">
            <div className="section-title mit-dark-title" data-aos="fade-up">
              ...
              <p>Effective cybersecurity requires more than deploying security tools. It requires ongoing management, monitoring, and operational discipline.</p>
            </div>

            <div className="cyber-principles-intro" data-aos="fade-up" data-aos-delay="100">
              <p>
                InfoManage integrates security practices into the daily management of technology environments
                to help reduce risk and maintain system integrity.
              </p>
            ...
            <p className="cyber-principles-footer" data-aos="fade-up" data-aos-delay="500">
              This operational approach ensures that cybersecurity remains an active part of managing business technology.
            </p>
          </div>
        </section>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 56, alignItems: 'center' }}>
              ...
              <div style={{ flex: '1 1 400px' }} data-aos="fade-up" data-aos-delay="250">
                ...
                <p style={{ color: 'rgba(255,255,255,0.72)', lineHeight: 1.8, marginBottom: 16, fontSize: 15 }}>
                  Security is most effective when integrated with the broader management of IT infrastructure.
        ...
        <section className="mit-section" style={{ background: '#fff' }}>
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>When a security issue occurs, rapid response is critical. InfoManage follows structured procedures designed to quickly identify, contain, and resolve security issues.</p>
            </div>
        ...
        <section className="mit-section" style={{ background: 'var(--light-bg)' }}>
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>Cybersecurity services from InfoManage are designed for organizations that:</p>
            </div>

            <div className="cyber-for-orgs-grid">
              {forOrgsItems.map((item, i) => (
                <div key={i} className="cyber-for-org-card" data-aos="fade-up" data-aos-delay={80 + i * 70}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 60, alignItems: 'center' }}>
              <div style={{ flex: '1 1 400px' }} data-aos="fade-up" data-aos-delay="100">
                ...
                <p style={{ color: '#666', lineHeight: 1.8, fontSize: 16, marginBottom: 14 }}>
                  Schedule a consultation to discuss your environment and learn how InfoManage can help
                  strengthen the security of your technology infrastructure.
                </p>
                <p style={{ color: '#999', fontSize: 14, lineHeight: 1.7 }}>
                  InfoManage integrates cybersecurity directly into IT operations — protecting your
                  systems without disrupting your business.
                </p>
              </div>
              ...
              <div style={{ flex: '1 1 400px' }} data-aos="fade-up" data-aos-delay="200">
                ...
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 24 }}>
                  ...
                  <Link to="/contact#contact" style={{ display: 'inline-block', padding: '12px 32px', borderRadius: 50, fontWeight: 600, border: '2px solid var(--accent)', color: 'var(--accent)', transition: '0.3s', fontSize: 15 }}
