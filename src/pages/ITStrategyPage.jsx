...
const vCTOCards = [
  {
    ...
    bullets: ['System lifecycle planning', 'Infrastructure upgrade scheduling', 'Technology investment prioritization'],
  },
  {
    num: '02',
    ...
    bullets: ['Architecture guidance', 'Vendor evaluation and selection', 'Strategic IT budgeting'],
  },
  {
    num: '03',
    ...
    bullets: ['Risk identification', 'Mitigation planning', 'Lifecycle risk management'],
  },
];
...
const lifecycleSteps = [
  { num: '01', icon: 'bi-hdd', title: 'Hardware Replacement Planning', desc: 'Scheduling hardware replacements before end-of-life to prevent unexpected failures and maintain system performance.' },
  { num: '02', icon: 'bi-window', title: 'Software Lifecycle Management', desc: 'Tracking software versions and support timelines to ensure environments remain supported and secure.' },
  { num: '03', icon: 'bi-arrow-clockwise', title: 'Infrastructure Modernization', desc: 'Identifying opportunities to modernize legacy systems to improve reliability, performance, and operational efficiency.' },
  { num: '04', icon: 'bi-speedometer', title: 'Capacity & Performance Planning', desc: 'Monitoring growth trends and planning infrastructure capacity to support future operational demands.' },
];
...
const forOrgsItems = [
  { icon: 'bi-pc-display', text: 'Depend heavily on reliable technology infrastructure' },
  { icon: 'bi-currency-dollar', text: 'Want guidance when making technology investments' },
  { icon: 'bi-calendar3', text: 'Require long-term planning for infrastructure and systems' },
  { icon: 'bi-arrow-repeat', text: 'Prefer proactive technology management rather than reactive decisions' },
        ...
        <section className="its-hero">
          ...
          <div className="container mit-hero-content" data-aos="fade-up" data-aos-delay="100">
            ...
            <p className="mit-hero-sub">
              Helping organizations plan, evolve, and align their technology infrastructure with long-term business goals.
            </p>
            <p className="mit-hero-body">
              Effective technology management requires more than maintaining systems. Organizations must also plan
              how their infrastructure will evolve as their operations grow and technology requirements change.
            </p>
            <p className="mit-hero-body">
              InfoManage provides strategic technology advisory to help organizations make informed decisions about
              their infrastructure, systems, and long-term technology investments.
            </p>
            <div className="mit-hero-btns">
              <Link to="/contact" className="btn-get-started">Schedule a Strategy Consultation</Link>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 56, alignItems: 'center' }}>
              ...
              <div style={{ flex: '1 1 400px' }} data-aos="fade-up" data-aos-delay="250">
                ...
                <p style={{ color: 'rgba(255,255,255,0.72)', lineHeight: 1.8, marginBottom: 16, fontSize: 15 }}>
                  Long-term planning helps organizations avoid reactive technology decisions and unexpected
                  infrastructure challenges. InfoManage works with organizations to develop technology roadmaps
                  that provide visibility into future infrastructure needs.
                </p>
                <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: 13, fontWeight: 700, marginBottom: 14, textTransform: 'uppercase', letterSpacing: 1 }}>
                ...
                <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: 14, lineHeight: 1.8, marginTop: 20, fontStyle: 'italic' }}>
                  These roadmaps allow organizations to plan investments more effectively while reducing operational risk.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="mit-gov-grid">
              {archItems.map((item, i) => (
                <div key={i} className="feature-card" data-aos="fade-up" data-aos-delay={150 + i * 60}>
        ...
        <section className="mit-section" style={{ background: 'var(--light-bg)' }}>
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>IT strategy and advisory services are designed for organizations that:</p>
            </div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 60, alignItems: 'center' }}>
              <div style={{ flex: '1 1 400px' }} data-aos="fade-up" data-aos-delay="100">
                ...
                <p style={{ color: '#666', lineHeight: 1.8, fontSize: 16, marginBottom: 14 }}>
                  Schedule a consultation to discuss your technology environment and learn how InfoManage can
                  help guide your infrastructure strategy.
                </p>
                <p style={{ color: '#999', fontSize: 14, lineHeight: 1.7 }}>
                  InfoManage works with organizations to periodically review their technology environment,
                  discuss operational performance, and identify areas for improvement — ensuring that technology
              ...
              <div style={{ flex: '1 1 400px' }} data-aos="fade-up" data-aos-delay="200">
                ...
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 24 }}>
                  <Link to="/contact" className="btn-get-started" style={{ padding: '12px 32px' }}>Schedule a Strategy Consultation</Link>
                  <Link to="/contact"
