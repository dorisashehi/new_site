        ...
        <section className="industries-hero">
          ...
          >
            ...
            <p className="mit-hero-sub">
              Supporting organizations that rely on stable, secure, and
              well-managed technology environments.
            </p>
            <p className="mit-hero-body">
              Technology plays a critical role in nearly every industry. From
              professional services firms to manufacturing companies and
              nonprofit organizations, businesses depend on reliable systems,
              secure data, and efficient infrastructure.
            </p>
            <p className="mit-hero-body">
              InfoManage supports organizations across many industries, helping
              them manage technology operations while ensuring that systems
              remain secure, stable, and aligned with business needs.
            </p>
        ...
        <section id="industries-list" className="services-section">
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>
                A tailored approach to operational IT management, built around
            ...
            >
              ...
              >
                ...
                <p data-aos="fade-right" data-aos-duration="800">
                  While every organization is unique, many industries share
                  common technology challenges. InfoManage provides operational
                  IT management and infrastructure support tailored to the
            ...
            <div data-aos="fade-up" data-aos-duration="1000">
              ...
              <div className="swiper-nav" style={{ marginTop: 24 }}>
                <button ref={prevRef} className="swiper-nav-btn">
                  <i className="bi bi-chevron-left" />
                </button>
                <button ref={nextRef} className="swiper-nav-btn">
          ...
          <div className="container">
            ...
            >
              <p style={{ color: "#666", fontSize: 15, lineHeight: 1.8 }}>
                InfoManage works with organizations that rely on technology to
                run daily operations. Regardless of industry, our focus is on
                maintaining stable infrastructure, providing responsive
                operational support, and helping organizations plan for future
                technology needs.
              </p>
              <p style={{ color: "#666", fontSize: 15, lineHeight: 1.8 }}>
                Our structured approach to IT operations ensures that systems
                remain reliable while supporting evolving business requirements.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            >
              ...
              >
                ...
                technology environment and learn how InfoManage can support your
