...
const plans = [
  {
    ...
    desc2:
      "Best suited for organizations that require monitoring and maintenance with optional additional services.",
  ...
  },
  {
    ...
    name: "Professional",
    desc1:
      "Expanded operational coverage with proactive infrastructure management and unlimited remote support during business hours.",
    desc2: null,
    features: [
      "Enhanced monitoring",
      "Endpoint protection",
      "Core IT service management governance",
    ],
    featured: true,
  },
  {
    ...
    name: "Enterprise",
    desc1:
      "Maximum service coverage for organizations requiring the highest level of operational support.",
    desc2: null,
    features: [
      "Expanded monitoring",
...
const govItems = [
  {
    ...
    desc: "Structured incident tracking with priority classification ensures critical issues receive immediate attention and appropriate escalation.",
  },
  {
    icon: "bi-arrow-left-right",
    title: "Change Management",
    desc: "Controlled processes govern all infrastructure modifications, minimizing risk and maintaining environment stability.",
  },
  {
    icon: "bi-activity",
    title: "Monitoring & Alerts",
    desc: "Continuous 24×7 infrastructure monitoring with automated alert response keeps your environment stable around the clock.",
  },
  {
    icon: "bi-file-earmark-text",
    title: "Infrastructure Documentation",
    desc: "Detailed documentation of your environment provides operational clarity and protects institutional knowledge.",
  },
  {
    icon: "bi-bar-chart-line",
    title: "Operational Reporting",
    desc: "Regular operational reports provide visibility into service delivery, system health, and trend analysis for informed decisions.",
  },
];
        ...
        <section className="mit-hero">
          ...
          >
            ...
            <p className="mit-hero-sub">
              Structured IT operations and infrastructure management for
              organizations that depend on reliable technology.
            </p>
            <p className="mit-hero-body">
              InfoManage provides comprehensive managed IT services that take
              responsibility for the day-to-day operation of your technology
              environment. Our team monitors, maintains, and supports your
              systems while helping your organization plan and evolve its
        ...
        <section id="overview" className="mit-dark-section">
          <div className="container">
            <div className="section-title mit-dark-title" data-aos="fade-up">
              ...
              <p>
                Operational responsibility for the stability, performance, and
        ...
        <section className="howwework-section">
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>
                A structured operational model designed to keep systems running
                smoothly while enabling continuous improvement
              </p>
            </div>
        ...
        <section id="operational-support" className="mit-dark-compare">
          ...
          >
            ...
            >
              ...
              >
                InfoManage clearly distinguishes between day-to-day operational
                support and larger infrastructure projects.
              </p>
              <p
                style={{
                  color: "rgba(255,255,255,0.55)",
              ...
              >
                This distinction ensures predictable service delivery while
                allowing organizations to plan technology improvements
                effectively.
              </p>
            </div>
              ...
              <div data-aos="fade-up" data-aos-delay="250">
                <div className="mit-dc-header mit-dc-header--project">
                  ...
                  <div>
                    <h4>Project Work</h4>
                    <span>
                      Major infrastructure changes or deployments are structured
                      as project work.
                    </span>
                  </div>
                </div>
            ...
            >
              ...
              >
                Projects that exceed defined thresholds are planned and
                delivered separately to ensure proper design and implementation.
              </p>
              <p
                style={{
              ...
              >
                This clear separation allows operational support to remain
                predictable while ensuring complex initiatives receive
        ...
        <section className="mit-section" style={{ background: "#f0f4f9" }}>
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>
                InfoManage offers multiple service plans designed to match the
                operational needs and risk tolerance of each organization
              </p>
            </div>
        ...
        >
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>
                Technology operations should be predictable and transparent.
                InfoManage service plans are designed to provide consistent
                operational coverage without unexpected service invoices.
              </p>
            </div>
            ...
            >
              ...
              >
                Organizations can choose pricing models that best fit their
              ...
              <ul className="mit-split-list" style={{ marginBottom: 28 }}>
                {[
                  ...
                  <li
                    key={i}
                    style={{ color: "#555", borderBottomColor: "#e8edf4" }}
                  >
                    <i className="bi bi-check2" />
                    {item}
                  </li>
              ...
              >
                These flexible options ensure that organizations receive
                appropriate coverage while maintaining cost efficiency.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mit-section">
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>
                Reliable IT operations require structured processes and
                accountability. InfoManage uses established ITSM practices to
                maintain operational discipline and visibility.
              </p>
            </div>

            <div
              className="mit-stats-bar"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              {[
            ...
            <p
              ...
              data-aos="fade-up"
            >
              These practices ensure that technology environments remain stable,
        ...
        >
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>
                Managed IT services from InfoManage are ideal for organizations
                that:
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  how structured IT management can improve reliability,
                  security, and operational efficiency.
                </p>
                <p style={{ color: "#999", fontSize: 14, lineHeight: 1.7 }}>
                  InfoManage has been serving organizations since 1995. Our team
                  brings decades of operational experience to every engagement.
                </p>
              </div>
